...
#ifndef ESPBOY_BEEP_H
#define ESPBOY_BEEP_H
 ...
 * `ESPBoyAudio` class will work since it has code to mute sound by setting
 ...
 *
 * For sketches that use `ESPBoy::nextFrame()`, or some other method to
 ...
 * \code{.cpp}
 * #include <ESPBoy.h>
 * // There's no need to #include <ESPBoyBeep.h>
 * // It will be included in ESPBoy.h
 *
 * ESPBoy espboy;
 ...
 *   espboy.pollButtons();
 *
 *   if (espboy.justPressed(A_BUTTON)) {
 ...
 * a DevKit ESPBoy because the speaker pins used cannot be directly controlled
